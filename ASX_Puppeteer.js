...
(async function main() {
  try {
    ...
    //Login
    await page.type("#issuerCode", "CTD");
    await page.click("#announcements-search > table > tbody > tr:nth-child(2) > td:nth-child(2) > select");
    await page.type("#announcements-search > table > tbody > tr:nth-child(2) > td:nth-child(2) > select", "The past 3 months");
    await page.click("#announcements-search > div > input");
      ...
      if (
        ...
        if (loop == 100) {
          ...
          var options = {
            ...
            directory:
              "/Volumes/GoogleDrive/My Drive/Enterprise digital/Clients/SalesForce/ConcurExtract2020/",
            filename: value + ".pdf"
          };
    ...
    console.log("Error for Report ID:", value, " - ", e);
  }
})();
